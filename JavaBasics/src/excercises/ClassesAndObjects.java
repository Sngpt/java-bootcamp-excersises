...
public class ClassesAndObjects {
    ...
    public static void main(String[] args) {
        Car oddisey = new Car("Honda","Odissey",2022);


        System.out.println("Make: "+oddisey.getMake());
        System.out.println("Model: " + oddisey.getModel());
        System.out.println("Year: "+ oddisey.getYear());
        System.out.println("Details: "+oddisey);
    }
}
